...
Create .env file inside your root folder, copy values from `/config/local-dotenv`.
Set `REACT_APP_API_HOST` value to your [movies-server](https://github.com/facebookincubator/create-react-app/issues) app address e.g. `http://localhost:8080`

To build app: `npm install`
